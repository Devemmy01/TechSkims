...
const navItems = [
  {
    icon: (
      ...
      >
        <path
          d="M4 11.4527V16.8007C4 17.9208 4 18.4812 4.21799 18.909C4.40973 19.2854 4.71547 19.591 5.0918 19.7828C5.5192 20.0006 6.07899 20.0006 7.19691 20.0006H16.8031C17.921 20.0006 18.48 20.0006 18.9074 19.7828C19.2837 19.591 19.5905 19.2854 19.7822 18.909C20 18.4816 20 17.9221 20 16.8041V11.4527C20 10.9184 19.9995 10.6511 19.9346 10.4024C19.877 10.1821 19.7825 9.97356 19.6546 9.78513C19.5102 9.5725 19.3096 9.39618 18.9074 9.04431L14.1074 4.84431C13.3608 4.19103 12.9875 3.86455 12.5674 3.74031C12.1972 3.63083 11.8026 3.63083 11.4324 3.74031C11.0126 3.86446 10.6398 4.19063 9.89436 4.84292L5.09277 9.04432C4.69064 9.39618 4.49004 9.5725 4.3457 9.78513C4.21779 9.97356 4.12255 10.1821 4.06497 10.4024C4 10.6511 4 10.9184 4 11.4527Z"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
  ...
  },
  {
    ...
    label: "Projects",
    path: "/technician-dashboard/projects",
  },
  {
    icon: (
      <svg
    ...
    path: "/technician-dashboard/reports",
  },
  {
    icon: (
      <svg
    ...
    label: "Messages",
    path: "/technician-dashboard/messages",
  },
];
...
const accountItems = [
  {
    icon: <Settings />,
    label: "Settings",
    path: "/technician-dashboard/settings",
  },
];
